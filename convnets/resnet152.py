...
x = IdentityModule(x, filters=(128, 128, 512))
x = IdentityModule(x, filters=(128, 128, 512)) 
x = IdentityModule(x, filters=(128, 128, 512)) # 5
x = IdentityModule(x, filters=(128, 128, 512))
x = IdentityModule(x, filters=(128, 128, 512)) 
x = IdentityModule(x, filters=(128, 128, 512)) # 8
...
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) # 25
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) # 30
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) 
x = IdentityModule(x, filters=(256, 256, 1024)) # 35
x = IdentityModule(x, filters=(256, 256, 1024)) # 36
...
model = tf.keras.Model(inputs=input, outputs=output, name='ResNet152')

if __name__ == '__main__':
    model.summary()
    tf.keras.utils.plot_model(model, os.path.join('architectures', 'resnet152_model.png'), show_shapes=True)
    # keras2ascii(model)
    visualkeras.layered_view(model, legend=True, to_file=os.path.join('architectures', 'resnet152_layers.png')).show()
